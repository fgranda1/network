# Generated by Django 3.0.7 on 2020-07-23 01:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ManyToManyField(blank=True, related_name='liker', to='network.Npost')),
            ],
        ),
        migrations.CreateModel(
            name='Follow',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('follow_to', models.ManyToManyField(blank=True, related_name='usern', to=settings.AUTH_USER_MODEL)),
